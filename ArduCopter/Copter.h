...
# include USERHOOK_VARIABLES
    ...
    void Log_Write_Guided_Attitude_Target(ModeGuided::SubMode submode, float roll, float pitch, float yaw, const Vector3f &ang_vel, float thrust, float climb_rate, uint32_t sender_time_ms = 0);
