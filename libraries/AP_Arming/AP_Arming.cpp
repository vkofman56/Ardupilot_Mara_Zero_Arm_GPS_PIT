...
const AP_Param::GroupInfo AP_Arming::var_info[] = {
    ...
    // @Bitmask: 0:Disable prearm display,1:Do not send status text on state change,2:Skip IMU consistency checks when ICE motor running,3:Skip lean angle arming check
    // @User: Advanced
