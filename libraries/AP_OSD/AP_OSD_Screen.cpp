...
const AP_Param::GroupInfo AP_OSD_Screen::var_info[] = {
    ...
    // @Description: Vertical position on screen
    // @Range: 0 21
    AP_SUBGROUPINFO(cell_volt, "CELLVOLT", 50, AP_OSD_Screen, AP_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 21
    AP_SUBGROUPINFO(batt_bar, "BATTBAR", 51, AP_OSD_Screen, AP_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 21
    AP_SUBGROUPINFO(arming, "ARMING", 52, AP_OSD_Screen, AP_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 21
    AP_SUBGROUPINFO(pluscode, "PLUSCODE", 53, AP_OSD_Screen, AP_OSD_Setting),
#endif
    ...
    // @Description: Vertical position on screen
    // @Range: 0 21
    AP_SUBGROUPINFO(callsign, "CALLSIGN", 54, AP_OSD_Screen, AP_OSD_Setting),
#endif
    ...
    // @Description: Vertical position on screen
    // @Range: 0 21
    AP_SUBGROUPINFO(current2, "CURRENT2", 55, AP_OSD_Screen, AP_OSD_Setting),
    ...
    // @Description: Vertical position on screen
    // @Range: 0 21
    AP_SUBGROUPINFO(vtx_power, "VTX_PWR", 56, AP_OSD_Screen, AP_OSD_Setting),
...
void AP_OSD_Screen::draw_gps_time(uint8_t x, uint8_t y)
{
    AP_GPS &gps = AP::gps();
    ...
    // Get UTC time (no timezone offset) from RTC which is GPS-synced
